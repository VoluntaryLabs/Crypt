...
usage () {
	echo "usages: "
	echo "	crypt3.sh [path to openssl] -decrypt -delete key path"
	echo "	crypt3.sh [path to openssl] -decrypt -keep   key path"
	echo "	crypt3.sh [path to openssl] -encrypt -delete key path"
	echo "	crypt3.sh [path to openssl] -encrypt -keep   key path"
	exit 1
}
